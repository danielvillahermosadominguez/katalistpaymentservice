...
public class SubscriptionUseCaseShould {
    ...
    private Clock dateService;
    private SubscribeToCourse useCase;
    ...
    void beforeEach() throws CustomFieldNotExists, MoodleNotRespond {
        ...
        dateService = mock(Clock.class);
        userNameService = mock(UserNameService.class);
        useCase = new SubscribeToCourse(
                holdedApiClient,
                moodleApiClient,
                payCometApiClient,
                dateService,
    ...
    @Test
    void check_if_the_course_exists_in_moodle() throws CourseNotExists, HoldedNotRespond, MoodleNotRespond, InvalidInputCustomerData, NoPriceAvailable, CustomFieldNotExists, UserIsEnroledInTheCourse, LearningPlatformIsNotAvailable, FinancialPlatformIsNotAvailable, TPVTokenIsRequired, CreditCardNotValid, NotValidEMailFormat {
    ...
    @Test
    void create_an_invoice_with_the_course_data() throws CourseNotExists, HoldedNotRespond, InvalidInputCustomerData, NotValidEMailFormat, CustomFieldNotExists, NoPriceAvailable, UserIsEnroledInTheCourse, LearningPlatformIsNotAvailable, FinancialPlatformIsNotAvailable, TPVTokenIsRequired, CreditCardNotValid {
